      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var t=localStorage.getItem('flintex_theme');document.documentElement.dataset.theme=t==='light'?'light':'dark'}catch(e){document.documentElement.dataset.theme='dark'}`,
          }}
        />
      </head>
      <body>
